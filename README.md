...
| [09_multi_RAG_agents_handsoff_sdk_identity/](09_multi_RAG_agents_handsoff_sdk_identity/) | Handoff specialists with agent ID (`id=`) for observability on Microsoft Foundry |
...
└── 09_multi_RAG_agents_handsoff_sdk_identity/
    ├── README.md                         # Project docs
    ├── blueprint.yaml                    # Blueprint v1.1 with id: per agent
    ├── blueprint_loader.py               # AgentIdentity with id field
    ├── main.py                           # Agent ID + Foundry/OTel observability
    ├── agent_tools.py                    # DOMAIN_TOOLS registry (same as 08)
    ├── domain_urls.py                    # URL lists split by domain
    ├── domain_providers.py               # ChromaWebContextProvider per domain
    ├── web_loader.py                     # Web scraping + chunking
    └── requirements.txt                  # Python dependencies
